...
# mentre per accedere ai singoli valori, si devono usare le chiavi 
# così come nelle liste si usavano
# gli indici:
...
# a differenza delle liste possiamo direttamente aggiungere una 
# coppia chiave valore senza usare l'append:

my_dic["new key"] = "new value"

# Possiamo stampare dizionari per intero, sapere il loro tipo e la loro 
# lunghezza (la quantità di chiavi-valore)
...
# infine, possiamo ciclare su un dizionario usando la funzione items() 
# che ci da insieme le coppie chiave-valore, che vengono
...
# dizionari e liste funzionano ovviamente anche insieme, quindi posso avere 
# un dizionario che contiene liste. Ad esempio immaginiamo
