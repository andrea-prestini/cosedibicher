...
class Omino:
    ...
    def __init__(self, colorito, capelli, occhi, bocca, pantaloni, maglietta):
        self._colorito = colorito
        self._capelli = capelli
        self._occhi = occhi
        self._bocca = bocca
        self._pantaloni = pantaloni
        self._maglietta = maglietta
